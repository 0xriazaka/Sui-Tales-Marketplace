...
module tale::royalty_rule {
    ...
    public fun add(
        policy: &mut TransferPolicy<Tale>,
        cap: &TransferPolicyCap<Tale>,
        amount_bp: u16,
        min_amount: u64
    ) {
    ...
    public fun pay(
        policy: &mut TransferPolicy<Tale>,
        request: &mut TransferRequest<Tale>,
        payment: Coin<SUI>
    ) {
    ...
    public fun fee_amount(policy: &TransferPolicy<Tale>, paid: u64): u64 {
